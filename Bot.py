...
async def handle_mpos_selection(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if ctype == "zebra_shid":
        notes = (
            "📌 **نکات مهم ابعادی:**\n"
            "• قاب بالای پرده حداقل ۱۰ سانتی‌متر فضای بالایی نیاز دارد تا مانع باز شدن پنجره نشود.\n\n"
        )
        if pos == "inside":
            detail = (
                "📏 **نحوه اندازه گیری پرده زبرا و شِید (نصب داخل چهارچوب):**\n\n"
                "• **عرض:** عرض را در ۳ نقطه اندازه گرفته، کوچک‌ترین عدد را انتخاب کنید و ۱ سانتی‌متر از آن کم کنید.\n\n"
                "• **ارتفاع:** ارتفاع را اندازه‌گیری کرده و ۲۰ سانتی‌متر به آن اضافه کنید."
            )
        else:
            detail = (
                "📏 **نحوه اندازه گیری پرده زبرا و شِید (نصب خارج از چهارچوب):**\n\n"
                "• **عرض:** عرض پنجره را اندازه‌گیری کرده و ۱۵ سانتی‌متر به آن اضافه کنید.\n\n"
                "• **ارتفاع:** ارتفاع پنجره را اندازه‌گیری کرده و ۲۰ سانتی‌متر به آن اضافه کنید."
            )
        ...
        if pos == "inside":
            detail = (
                "📏 **نحوه اندازه‌گیری پرده کرکره فلزی (نصب داخل چهارچوب):**\n\n"
                "• **عرض:** عرض چهارچوب − ۱ سانتی‌متر\n\n"
                "• **ارتفاع:** ارتفاع چهارچوب + ۵ سانتی‌متر\n\n"
                "🔹 **عمق مورد نیاز:** حداقل ۵ سانتی‌متر"
            )
        else:
            detail = (
                "📏 **نحوه اندازه‌گیری پرده کرکره فلزی (نصب بیرون چهارچوب):**\n\n"
                "• **عرض:** عرض چهارچوب + ۱۰ سانتی‌متر\n\n"
