...
async def handle_mpos_selection(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    tools_text = (
        ...
        "مترهای فلزی بهترین وسیله برای اندازه‌گیری هستند. این نوارها قابلیت اندازه‌گیری دقیق سانتی‌متر و حتی میلی‌متری را دارند و امکان خطای اندازه‌گیری را کاهش می‌دهند. "
